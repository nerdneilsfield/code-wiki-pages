...
### [诊断核心](CLI_Doctor_Commands-维护与修复-诊断核心.md)
...
**详细文档**：[诊断核心](CLI_Doctor_Commands-维护与修复-诊断核心.md)

### [Hook 集成检测与修复](CLI_Doctor_Commands-维护与修复-hook_集成检测与修复.md)
...
**详细文档**：[Hook 集成检测与修复](CLI_Doctor_Commands-维护与修复-hook_集成检测与修复.md)

### [维护清理执行](CLI_Doctor_Commands-维护与修复-维护清理执行.md)
...
**详细文档**：[维护清理执行](CLI_Doctor_Commands-维护与修复-维护清理执行.md)
...
- [诊断核心](CLI_Doctor_Commands-诊断核心.md) - 父模块，包含 doctor 命令的整体架构
- [诊断核心](CLI_Doctor_Commands-维护与修复-诊断核心.md) - 本模块在诊断核心中的位置
- [Hook 集成检测与修复](CLI_Doctor_Commands-维护与修复-hook_集成检测与修复.md) - Hook 管理器检测与集成验证详解
- [维护清理执行](CLI_Doctor_Commands-维护与修复-维护清理执行.md) - 清理操作实现详解
