...
- [application_settings_state_contracts](application_settings_state_contracts.md) —— 同级的应用设置状态管理
- [api_contracts_for_backend_integrations](api_contracts_for_backend_integrations.md) —— 后端 API 契约定义
- [session_lifecycle_api](session_lifecycle_api.md) —— 会话生命周期 API（与此模块的会话菜单项相关）
