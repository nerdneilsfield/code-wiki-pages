...
- **[Get Started](guide-getting-started.md)**  
  快速安装与首次运行指南，适合希望尽快把示例“跑起来”的读者。你可以在最短路径下完成环境准备、命令执行与结果验证。

- **[Beginner's Guide](guide-beginners-guide.md)**  
  面向初学者的多章节入门教程，从基础概念到实践步骤逐层展开。适合希望系统理解 HLS 思维方式与常见开发流程的读者。

- **[Build & Code Organization](guide-build-and-organization.md)**  
  详解项目构建流水线与代码组织结构，帮助你理解示例仓库如何编译、链接与管理模块。对于团队协作、二次开发和工程规范化尤其实用。

- **[Core Algorithms](guide-core-algorithms.md)**  
  提供核心算法的形式化深度解析，关注原理、实现与硬件映射之间的关系。适合需要进一步优化性能或验证算法正确性的进阶开发者。
